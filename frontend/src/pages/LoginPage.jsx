    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-center items-center px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/40 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-xl shadow-2xl relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Access your personalized AI career dashboard</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-slate-950/60 border border-slate-800 focus:border-indigo-500/80 rounded-xl focus:outline-none focus:ring-1 focus:ring-indigo-500/30 transition-all placeholder:text-slate-600 text-sm"
                required
              />
            </div>
          </div>
